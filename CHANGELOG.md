...
**Deferred (5 design items):** multi-element gradient duplication, image/a internal refs, setUseData on undo/redo, fill/stroke pushdown on ungroup, importSvgString namespace caching.
