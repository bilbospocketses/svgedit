export default {
  ...
  tools: {
    ...
    editor_homepage: 'svgedit Home Page',
  ...
  notification: {
    ...
    editorPreferencesMsg: 'By default and where supported, svgedit can store your editor preferences and SVG content locally on your machine so you do not need to add these back each time you load svgedit. If, for privacy reasons, you do not wish to store this information on your machine, you can change away from the default option below.',
